...
/**
 * Pulls EqualsTo expressions out of AndExpression
 */
public class SortMergeJoinExpressionVisitor implements ExpressionVisitor {
    private final List<BinaryExpression> expressions;

    public SortMergeJoinExpressionVisitor() {
